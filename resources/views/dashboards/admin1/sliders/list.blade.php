        ...
        <div class="row page-titles">
            <div class="col-md-6 col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item  active"><a href="javascript:void(0)">Sliders Listing</a></li>
                </ol>
            </div>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            data-bs-toggle="modal" 
                                                            data-bs-target="#pagemodal"
                                                            data-page="{{ route('slider.edit', ['slider'=>$result->id]) }}"
                                                        ...
                                                        <td>
                                                            <form action="{{ route('slider.destroy', ['slider'=> $result->id]) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
