        ...
        <div class="row page-titles">
            <div class="col-md-6 col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item  active"><a href="javascript:void(0)">Team Listing</a></li>
                </ol>
            </div>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            data-bs-toggle="modal" 
                                                            data-bs-target="#pagemodal"
                                                            data-page="{{ route('team.edit', ['team'=>$result->id]) }}"
                                                        ...
                                                        <td>
                                                            <form action="{{ route('team.destroy', ['team'=> $result->id]) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
