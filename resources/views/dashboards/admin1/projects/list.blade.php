        ...
        <div class="row page-titles">
            <div class="col-md-6 col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item  active"><a href="javascript:void(0)">Project Listing</a></li>
                </ol>
            </div>
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <button 
                    ...
                    data-page="{{ route('projects.create') }}"
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            data-bs-toggle="modal" 
                                                            data-bs-target="#pagemodal"
                                                            data-page="{{ route('projects.edit', ['project'=>$result->id]) }}"
                                                        ...
                                                        <td>
                                                            <form action="{{ route('projects.destroy', ['project'=> $result->id]) }}" method="post">
                                                                @csrf
                                                                @method('DELETE')
