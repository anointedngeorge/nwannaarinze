                ...
                <div class="row">
                            ...
                            <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="become-volunteer__img-single">
                                            <img src="{{ asset("storage/" . $event->image ?? 'assets/images/images/become-volunteer-img-2.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="become-volunteer__right">
                            <form class="become-volunteer__form" method="POST" action="{{ route("frontend.event_registration_store" ) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-4">
                                        <div class="become-volunteer__input">
                                            <input class="form-control" type="text" hidden  value="{{ $event->id }}" name="event">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="become-volunteer__input">
                                            <input type="text" placeholder="state of resident" name="state_of_resident" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="become-volunteer__input">
                                            <input type="text" placeholder="submit expectation" name="submit_expectation" required id="submit_expectation">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="become-volunteer__input">
