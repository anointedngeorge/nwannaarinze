<div class="rts-about-area-two rts-section-gap">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="left-thumbnail-about-area-two">
                    <img src="invena/images/about/04.webp" alt="about">
                    <div class="small-image">
                        <img src="invena/images/about/05.webp" alt="small">
                    </div>
            ...
            <div class="col-lg-6 mt_sm--80 mt_md--80">
                <div class="about-inner-content-two">
                    ...
                    <div class="call-and-sign-area two">
                        ...
                        <div class="sign-area">
                            <img src="invena/images/about/sign.svg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="shape-area">
        <img src="invena/images/about/shape/01.svg" alt="shape" class="one">
        <img src="invena/images/about/shape/02.svg" alt="shape" class="two">
    </div>
</div>