            ...
            <div class="col-xl-5 col-lg-6">
                <div class="help-people__left">
                    ...
                    <div class="help-people__content">
                        <p class="help-people__text">Join a growing community of passionate individuals making a real difference. From lending a helping hand to supporting life-changing projects, our volunteers are at the heart of every impact we create.</p>
                        <a href="become-volunteer.html" class="thm-btn help-people__btn">Become A Partner</a>
                    </div>
                </div>
            </div>
