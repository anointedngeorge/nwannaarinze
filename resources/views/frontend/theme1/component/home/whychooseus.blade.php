    ...
    <div class="container">
        ...
        <div class="row g-5 mt--10">
            <div class="col-lg-4 col-md-6 col-sm-12 rts-jump__item">
                <div class="single-why-choose-four">
                    <a href="#" class="thumbnail">
                        <img src="invena/images/why-choose/04.webp" alt="choose">
                    </a>
                    <div class="inner-content">
                        <div class="icon">
                            <img src="invena/images/why-choose/icons/01.svg" alt="why-choose">
                        </div>
                        <a href="#">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 rts-jump__item">
                <div class="single-why-choose-four">
                    <a href="#" class="thumbnail">
                        <img src="invena/images/why-choose/05.webp" alt="choose">
                    </a>
                    <div class="inner-content">
                        <div class="icon">
                            <img src="invena/images/why-choose/icons/02.svg" alt="why-choose">
                        </div>
                        <a href="#">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 rts-jump__item">
                <div class="single-why-choose-four">
                    <a href="#" class="thumbnail">
                        <img src="invena/images/why-choose/06.webp" alt="choose">
                    </a>
                    <div class="inner-content">
                        <div class="icon">
                            <img src="invena/images/why-choose/icons/03.svg" alt="why-choose">
                        </div>
                        <a href="#">
