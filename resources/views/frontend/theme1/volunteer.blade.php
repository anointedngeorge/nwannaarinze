                ...
                <div class="row">
                        ...
                        <div class="become-volunteer__Left">
                            ...
                            <div class="become-volunteer__images">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="become-volunteer__img-single">
                                            <img src="{{ asset('assets/images/images/become-volunteer-img-2.jpg') }}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="become-volunteer__right">
                            <form class="become-volunteer__form" method="POST" action="{{ route( 'frontend.volunteer' ) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-xl-12">
